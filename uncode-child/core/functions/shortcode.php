...
function curso_func( $atts ){
	...
	ob_start();
			...
			if ( $the_query->have_posts() ) :
				...
				<div class="swiper-container tax-<?php echo $atts['taxonomy']; ?>">
...
add_shortcode( 'curso-column', 'curso_column_func' );
function curso_column_func( $atts ){
...
/*	    width: calc( 100% - 270px);*/
	...
	.acoes-de-formacao .cat-cursos {
	    background-color: #6BC17E;
	    border-color: #6BC17E
	}
