										...
										<div class="menu-horizontal text-center text-mobile-center filter-alignment-center ">
											...
											<ul class="menu-smart sm text-uppercase menu-smart--filter-cats " data-smartmenus-id="16913235874376055">
												...
												<li class="filter-show-all">
													<span>
														<a href="https://deco.pt/noticia" data-id="" class="<?php echo $showall; ?> isotope-nav-link grid-nav-link">Mostrar todas</a>
													</span>
												</li>
												...
												<?php foreach( $terms as $term ) : ?>
													...
													<li class="filter-cat-<?php echo $term->term_id; ?> filter-cat">
														<span>
															<a href="https://deco.pt/noticia?category=<?php echo $term->term_id; ?>" data-id="<?php echo $term->term_id; ?>" class="<?php echo $active; ?> noticia-filter-link isotope-nav-link grid-nav-link"><?php echo $term->name; ?></a>
														</span>
													</li>
