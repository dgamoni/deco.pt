...
if ( have_posts() || uncode_is_filtering() ):
	...
	ob_start();
		get_template_part('template-parts/tax', 'explorars');
          ...
          <div class="post-wrapper">
          	<div class="post-body">
          		<div class="slider_content">
          			<a href="'.home_url('/sobreviver-a-crise/').'" class="mainlogo"><img src="https://deco.pt/wp-content/themes/uncode-child/core/img/deco-protecao-financeira.svg"></a>'
          			. $slider_content .
          		'</div>'	 
